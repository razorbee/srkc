<?php
class Auditing_Recent_Posts extends WP_Widget {
	#1.constructor
	function __construct() {
		$widget_options = array('classname'=>'widget_recent_posts', 'description'=>esc_html__('To list out posts', 'designthemes-core'));
		parent::__construct(false,AUDITING_THEME_NAME.esc_html__(' Posts','designthemes-core'),$widget_options);
	}
			 ...
			 while($the_query->have_posts()):
				...
				echo "<li>";
					if(1 == $_enabled_image):
						...
						$image = ( $image != false)? $image[0] : AUDITING_THEME_URI . '/images/dummy-images/post-thumb.jpg';
					...
					if($show_title):
						...
						echo "<div class='entry-title'><h4><a href='".get_permalink()."'>{$title}</a></h4></div>";
						echo "<div class='entry-content'>".auditing_excerpt(10)."</div>";
					endif;

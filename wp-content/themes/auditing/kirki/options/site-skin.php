...
AUDITING_Kirki::add_section( 'dt_site_skin_section', array(
	'title' => esc_html__( 'Site Skin', 'auditing' ),
	'priority' => 23
) );
	...
	AUDITING_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Predefined Skin ?', 'auditing' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 1,
		'default'  => auditing_defaults('use-predefined-skin' ),
		'choices'  => array(
	...
	AUDITING_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Skin', 'auditing' ),
		'section'  => 'dt_site_skin_section',
		'default' => auditing_defaults('predefined-skin' ),
		'multiple' => 1,
		'priority' => 2,
		...
		'choices' => array(
			'blue'			=>	esc_attr__('Blue','auditing'),			'brown'			=>	esc_attr__('Brown','auditing'),
			'cadetblue'		=>	esc_attr__('Cadet Blue','auditing'),	'chilipepper'	=>	esc_attr__('Chili Pepper','auditing'),
			'cyan'			=>	esc_attr__('Cyan','auditing'),			'darkgolden'	=>	esc_attr__('Dark Golden','auditing'),
			'deeporange'	=>	esc_attr__('Deep Orange','auditing'),	'deeppurple'	=>	esc_attr__('Deep Purple','auditing'),
			'green'			=>	esc_attr__('Green','auditing'),			'lime'			=>	esc_attr__('Lime','auditing'),
			'magenta'		=>	esc_attr__('Magenta','auditing'),		'orange'		=>	esc_attr__('Orange','auditing'),
			'pink'			=>	esc_attr__('Pink','auditing'),			'purple'		=>	esc_attr__('Purple','auditing'),
			'red'			=>	esc_attr__('Red','auditing'),			'skyblue'		=>	esc_attr__('Sky Blue','auditing'),
			'teal'			=>	esc_attr__('Teal','auditing'),			'turquoise'		=>	esc_attr__('Turquoise','auditing'),
			'wisteria'		=>	esc_attr__('Wisteria','auditing'),		'yellow'		=>	esc_attr__('Yellow','auditing'),
		)
	));
	...
	AUDITING_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Primary Color', 'auditing' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 3,
		'choices' => array( 'alpha' => true ),
		'default'  => auditing_defaults('primary-color'),
		'active_callback' => array(
		...
		'output' => array(
			...
			array( 'element' => '.top-bar a:hover, .menu-icons-wrapper .search a:hover, .menu-icons-wrapper .cart a:hover, .breadcrumb a:hover, /* New */ .top-bar .dt-sc-sociable li a:hover', 'property' => 'color' ),
			...
			array( 'element' => '#footer a:hover, #footer .footer-copyright .menu-links li a:hover, #footer .footer-copyright .copyright-left a:hover, #footer .dt-sc-dark-bg .recent-posts-widget li .entry-meta a:hover, #footer .dt-sc-dark-bg .entry-title h4 a:hover, #footer .dt-sc-dark-bg a:hover, .left-header-footer .dt-sc-sociable.filled li a, /* New */ .footer-widgets .dt-sc-contact-info.type1 a:hover', 'property' => 'color' ),
			...
			array( 'element' => 'ul.side-nav li a:hover, .available-domains li span, .dt-sc-popular-procedures .details .duration, .dt-sc-popular-procedures .details .price, .dt-sc-text-with-icon span, blockquote.type4 > cite, .dt-sc-contact-info.type3 span, .dt-sc-pr-tb-col.type2 .dt-sc-buy-now a, .dt-sc-events-list .dt-sc-event-title h5 a, .woocommerce-MyAccount-navigation ul > li.is-active > a, /* New */ .dt-sc-newsletter-section.type7 .dt-sc-subscribe-frm:before, .dt-sc-donutchart-small:hover *, .dt-sc-donutchart-medium:hover *, .dt-sc-donutchart-large:hover *, .dt-sc-image-caption.type7:hover .dt-sc-image-content h3', 'property' => 'color' ),

			# Primary Color - Buttons	
			array( 'element' => '.dt-sc-button.fully-rounded-border, .dt-sc-button.rounded-border, .dt-sc-button.bordered, .dt-sc-button.with-shadow.white, .dt-sc-skin-highlight .dt-sc-button.rounded-border:hover, .dt-sc-skin-highlight .dt-sc-button.bordered:hover, .dt-sc-dark-bg.skin-color .dt-sc-button.fully-rounded-border:hover, /* New */ .dt-sc-icon-box.type2:hover .icon-content h5', 'property' => 'color' ),

			# Primary Color - Icon Boxes	
			array( 'element' => '.dt-sc-icon-box.type1 .icon-wrapper .icon, .dt-sc-icon-box.type2 .icon-wrapper .icon, .dt-sc-icon-box.type4 .icon-wrapper span, .dt-sc-icon-box.type5:hover .icon-content h4 a, .dt-sc-icon-box.type5.no-icon-bg .icon-wrapper span, .dt-sc-icon-box.type5.no-icon-bg:hover .icon-wrapper span, .dt-sc-icon-box.type10 .icon-wrapper span, .dt-sc-icon-box.type10:hover .icon-content h4, .dt-sc-icon-box.type13 .icon-content h4, .dt-sc-icon-box.type14 .icon-content h4, /* New */ .dt-sc-icon-box.type3:hover .icon-content h5, .dt-sc-icon-box.type3.with-shadow:hover .icon-content h4', 'property' => 'color' ),
			...
			array( 'element' => '.dt-sc-counter.type3.diamond-square h4, .dt-sc-counter.type6:hover h4, /* New */ .dt-sc-counter.type1 .icon-wrapper span', 'property' => 'color' ),

			# Primary Color - Add-ons/Custom Modules	
			array( 'element' => '.dt-sc-menu-sorting a:hover, .dt-sc-menu-sorting a.active-sort, .dt-sc-training-details h6, .dt-sc-fitness-diet:hover .dt-sc-fitness-diet-details h5, table.fit-Diet-table th strong, .dt-sc-hotel-room-single-metadata ul li, .dt-sc-hotel-room .dt-sc-hotel-room-details ul li, /* New */ .bordered-content-box h2, .bordered-content-box h4, .main-header .menu-icons-wrapper .overlay-search #searchform:before, .section20 .year, .section21 .stats-number, .section53 .aio-icon.advanced, .section38 .aio-icon, .section38 .aio-icon-header h3.aio-icon-title', 'property' => 'color' ),
...
.menu-icons-wrapper.rounded-icons .search a span:hover, .menu-icons-wrapper.rounded-icons .cart a span:hover, .menu-icons-wrapper .cart sup', 'property' => 'background-color' ),
			...
			array( 'element' => '
				...
				.dt-sc-dark-bg .tagcloud a:hover, .dt-sc-dark-bg .widget.widget_categories ul li > a:hover span, #footer .dt-sc-dark-bg .widget.widget_categories ul li > a:hover span, #footer .dt-sc-dark-bg .widget.widget_archive ul li > a:hover span, /* New */ #footer .widget:hover .widgettitle:before', 'property' => 'background-color' ),	
			...
			array( 'element' => '.dt-sc-pr-tb-col.minimal:hover .dt-sc-price, .dt-sc-pr-tb-col.minimal.selected .dt-sc-price, .dt-sc-pr-tb-col:hover .dt-sc-buy-now a, .dt-sc-pr-tb-col.selected .dt-sc-buy-now a, .dt-sc-pr-tb-col.minimal:hover .icon-wrapper:before, .dt-sc-pr-tb-col.minimal.selected .icon-wrapper:before, .dt-sc-pr-tb-col.type1:hover .dt-sc-tb-header, .dt-sc-pr-tb-col.type1.selected .dt-sc-tb-header, .dt-sc-pr-tb-col.type2 .dt-sc-tb-header .dt-sc-tb-title:before, .dt-sc-pr-tb-col.type2 .dt-sc-tb-content:before, .dt-sc-pr-tb-col.type2 .dt-sc-tb-content li .highlight, .dt-sc-pr-tb-col.type2:hover .dt-sc-price:before, .dt-sc-pr-tb-col.type2.selected .dt-sc-price:before, .dt-sc-pr-tb-col.type2:hover .dt-sc-buy-now a, /* New */ .dt-sc-pr-tb-col.type1.selected, .dt-sc-pr-tb-col.type1:hover', 'property' => 'background-color' ),
			...
			array( 'element' => '.dt-sc-image-caption.type4:hover .dt-sc-button, .dt-sc-image-caption.type8 .dt-sc-image-content:before, .dt-sc-event-image-caption:hover, /* New */ .dt-sc-image-caption.type8 .dt-sc-image-content:after', 'property' => 'background-color' ),	
			...
			array( 'element' => '.live-chat a, .dt-bmi-inner-content tbody th, .dt-bmi-inner-content tbody tr:nth-child(2n+1) th, .dt-sc-menu .menu-categories a:before, .hotel-search-container form input[type="submit"]:hover, .hotel-search-container .selection-box:after, .dt-sc-training-details-overlay, /* New */ .vacancy_form span:after, .vac_form_title p', 'property' => 'background-color' ),
			...
			array( 'element' => '.dt-sc-colored-big-buttons:hover, .dt-sc-button.fully-rounded-border, .dt-sc-button.fully-rounded-border:hover, .dt-sc-button.rounded-border.black:hover, .dt-sc-button.bordered.black:hover, .dt-sc-button.bordered:hover, .dt-sc-button.rounded-border:hover', 'property' => 'border-color' ),
			...
			array( 'element' => '.dt-sc-icon-box.type5.no-icon .icon-content h4, .dt-sc-icon-box.type5.no-icon, .dt-sc-icon-box.type10, .dt-sc-icon-box.type10 .icon-wrapper:before, .dt-sc-icon-box.type3.dt-sc-diamond:hover .icon-wrapper:after, /* New */ .dt-sc-icon-box.type3:hover .icon-wrapper span', 'property' => 'border-color' ),
			...
			array( 'element' => '.dt-sc-up-arrow:before, .dt-sc-image-caption .dt-sc-image-wrapper .icon-wrapper:before, .dt-sc-triangle-wrapper.alter:hover .dt-sc-triangle-content:before, .dt-sc-content-with-hexagon-shape:before, .dt-sc-tabs-horizontal-frame-container.type3 ul.dt-sc-tabs-horizontal-frame > li > a.current, .dt-sc-tabs-horizontal-frame-container.type4 ul.dt-sc-tabs-horizontal-frame > li > a.current, /* New */ .dt-sc-pr-tb-col.type1 .dt-sc-tb-content li, .main-header .menu-icons-wrapper .overlay-search #searchform, .section21 .stats-block, .dt-sc-image-caption.type7.bottom-content .dt-sc-image-wrapper:before', 'property' => 'border-bottom-color' ),

			# Primary Border Left Color - Miscellaneous/Shortcodes
			array( 'element' => '.type3 .dt-sc-toggle-frame .dt-sc-toggle-content, .dt-sc-tabs-vertical-frame-container.type3 ul.dt-sc-tabs-vertical-frame > li > a.current:before, .dt-sc-event-image-caption:hover .dt-sc-image-content:before, /* New */ .section21 .stats-block, .dt-sc-image-caption.type7.left-content .dt-sc-image-wrapper:before', 'property' => 'border-left-color' ),
			
			# Primary Border Right Color - Miscellaneous/Shortcodes
			array( 'element' => '/* New */ .dt-sc-image-caption.type7 .dt-sc-image-wrapper:before', 'property' => 'border-right-color' ),

			# Primary Border Color - Add-ons/Custom Modules
			array( 'element' => '.dt-sc-attorney-sorting, .dt-sc-menu-sorting a.active-sort, .dt-sc-menu .image-overlay .price, .hotel-search-container form input[type="submit"], /* New */ .bordered-content-box:before', 'property' => 'border-color' ),
			...
			array( 'element' => '.woo-type15 ul.products li.product .product-thumb a.add_to_cart_button:after, .woo-type15 ul.products li.product .product-thumb a.button.product_type_simple:after, .woo-type15 ul.products li.product .product-thumb a.button.product_type_variable:after, .woo-type15 ul.products li.product .product-thumb a.added_to_cart.wc-forward:after, .woo-type15 ul.products li.product .product-thumb a.add_to_wishlist:after, .woo-type15 ul.products li.product .product-thumb .yith-wcwl-wishlistaddedbrowse a:after, .woo-type15 ul.products li.product .product-thumb .yith-wcwl-wishlistexistsbrowse a:after, .woo-type15 ul.products li.product .price:after, .dt-sc-hotel-room:hover .dt-sc-hotel-room-details', 'property' => 'background-color' ),
	...
	AUDITING_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Secondary Color', 'auditing' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 4,
		'choices' => array( 'alpha' => true ),
		'default'  => auditing_defaults('secondary-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
			...
			array( 'element' => '
				...
				.dt-sc-button.filled:hover, .dt-sc-button.with-icon.icon-right.type1:hover, .dt-sc-counter.type2:hover .dt-sc-couter-icon-holder, /* .dt-sc-icon-box.type3:hover .icon-wrapper span, */ .dt-sc-newsletter-section.type2 .dt-sc-subscribe-frm input[type="submit"]:hover, .skin-highlight .dt-sc-testimonial.type6 .dt-sc-testimonial-author:before, .skin-highlight .dt-sc-testimonial.type6:after, .dt-sc-team-social.rounded-square li a:hover, .dt-sc-video-wrapper .video-overlay-inner a:hover, #dt-consent-extra-info.dt-inline-modal .mfp-close:hover', 'property' => 'background-color' ),

			# Secondary Border Color - Miscellaneous/Shortcodes
			array( 'element' => '.dt-sc-contact-info.type5 .dt-sc-contact-icon, .dt-sc-contact-info.type5 .dt-sc-contact-icon:before, .dt-sc-contact-info.type5 .dt-sc-contact-icon:after, .dt-sc-image-caption.type2:hover .dt-sc-image-content, .dt-sc-sociable.hexagon-with-border li, .dt-sc-sociable.hexagon-with-border li:before, .dt-sc-sociable.hexagon-with-border li:after', 'property' => 'border-color' ),	
	...
	AUDITING_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Tertiary Color', 'auditing' ),
		'section'  => 'dt_site_skin_section',
		'priority' => 5,
		'choices' => array( 'alpha' => true ),
		'default'  => auditing_defaults('tertiary-color'),
		'active_callback' => array(
			array( 'setting' => 'use-predefined-skin', 'operator' => '==', 'value' => '0' )
		),
		'output' => array(
			...
			array( 'element' => '.dt-sc-triangle-title:before, .dt-sc-icon-box.type10 .icon-wrapper:after, /* New */ .skin-light-highlight, .dt-sc-pr-tb-col.type1', 'property' => 'background-color' ),	
			
			# Tertiary Color - Shortcodes
			array( 'element' => '/* New */ .dt-sc-pr-tb-col.type1 .dt-sc-buy-now a', 'property' => 'color' ),
			...
			# Tertiary BG Color - Room Add-on
			array( 'element' => '.dt-sc-hotel-room .dt-sc-hotel-room-details', 'property' => 'background-color' ),
	...
	AUDITING_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Site BG Color', 'auditing' ),
		'section'  => 'dt_site_skin_section',
		'output'   => array(
			array( 
		...
		'choices' => array( 'alpha' => true ),
		'default'  => auditing_defaults('body-bg-color'),
	));
	...
	AUDITING_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Site Content Color', 'auditing' ),
		'section'  => 'dt_site_skin_section',
		'output'   => array(
		...
		'choices' => array( 'alpha' => true ),
		'default'  => auditing_defaults('body-content-color'),
	));
	...
	AUDITING_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Site Link Color', 'auditing' ),
		'section'  => 'dt_site_skin_section',
		'output'   => array(
		...
		'choices' => array( 'alpha' => true ),
		'default'  => auditing_defaults('body-a-color'),
	));
	...
	AUDITING_Kirki::add_field( $config, array(
		...
		'label'    => esc_html__( 'Site Link Hover Color', 'auditing' ),
		'section'  => 'dt_site_skin_section',
		'output'   => array(
		...
		'choices' => array( 'alpha' => true ),
		'default' => auditing_defaults('body-a-hover-color'),
	));
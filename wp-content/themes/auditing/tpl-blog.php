...
get_header();
    ...
    <section id="primary" class="<?php echo esc_attr( $page_layout );?>"><?php
                        ...
                        <?php if( $post_style == "entry-date-left"): ?>
                                ...
                                <div class="entry-details">
                                    ...
                                    <?php if( $tpl_default_settings['blog-post-excerpt'] == 'true' && $tpl_default_settings['blog-post-excerpt-length'] != '' ):?>
                                    		<div class="entry-body"><?php echo auditing_excerpt($tpl_default_settings['blog-post-excerpt-length']);?></div>
                                    <?php endif;?>
                        ...
                        <?php else: # Default Post Style ?>
                        		<div class="entry-details">
                                    ...
                                    <div class="entry-meta <?php echo esc_attr($tclass);?>">
                                    	...
                                    	<div class="date <?php echo esc_attr($show_date_meta);?>"><?php esc_html_e('Posted on','auditing'); echo get_the_date(' d M Y');?></div>
        ...
        <!-- **Pagination** -->
        <div class="pagination blog-pagination"><?php echo auditing_pagination($the_query); ?></div><!-- **Pagination** -->
        <!-- Blog Template Ends -->

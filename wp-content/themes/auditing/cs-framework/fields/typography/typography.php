...
class CSFramework_Option_typography extends CSFramework_Options {
  ...
  public function output() {
    ...
    if( is_object( $google_json ) ) {
      ...
      echo '<optgroup label="'. esc_attr__( 'Web Safe Fonts', 'auditing' ) .'">';
      ...
      echo '<optgroup label="'. esc_attr__( 'Google Fonts', 'auditing' ) .'">';
      ...
      echo esc_html__( 'Error! Can not load json file.', 'auditing' );

...
class CSFramework_Option_switcher extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<label><input type="checkbox" name="'. $this->element_name() .'" value="1"'. $this->element_class() . $this->element_attributes() . checked( $this->element_value(), 1, false ) .'/><em data-on="'. esc_attr__( 'on', 'auditing' ) .'" data-off="'. esc_attr__( 'off', 'auditing' ) .'"></em><span></span></label>' . $label;

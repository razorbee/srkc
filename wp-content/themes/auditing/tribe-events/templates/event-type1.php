    ...
    <p class="nav-top-links">
        <a href="<?php echo esc_url( tribe_get_events_link() ); ?>" class="back-nav"><?php esc_html_e('All Events', 'auditing'); ?></a>
        <span class="sep">/</span>
        <a href="<?php echo esc_url( tribe_get_gcal_link($event_id) ); ?>"><?php esc_html_e('+ Google Calendar', 'auditing'); ?></a>
        <span class="sep">/</span>
        <a href="<?php echo esc_url( tribe_get_ical_link() ); ?>"><?php esc_html_e('+ iCal Export', 'auditing'); ?></a>
    </p>
	<h2><?php the_title(); ?></h2>
    ...
    <p class="event-schedule"><?php
      ...
      if(class_exists( 'Tribe__Events__Pro__Main' )): ?>
          | <a href="#" class="dt-sc-tooltip-top" title="<?php echo tribe_get_recurrence_text ( $event_id ); ?>"><?php esc_html_e('Recurring Event (See all)', 'auditing'); ?></a><?php
      endif; ?>
    </p>
    ...
    <div class="dt-sc-two-third column first">
      <div class="event-image-wrapper">
          ...
          <?php echo tribe_event_featured_image( $event_id, 'auditing-event-single-type1', false ); ?>
      </div>    
